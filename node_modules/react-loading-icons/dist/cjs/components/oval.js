...
function Oval(props) {
    ...
    return (react_1.default.createElement("svg", __assign({}, __assign(__assign({}, props), { className: props.className
        ...
        react_1.default.createElement("g", __assign({ transform: "translate(1 1)", fill: "none", fillRule: "evenodd" }, { stroke: stroke, strokeWidth: strokeWidth, strokeOpacity: strokeOpacity }),
            ...
            react_1.default.createElement("path", { d: "M36 18c0-9.94-8.06-18-18-18" },
                react_1.default.createElement("animateTransform", { attributeName: "transform", type: "rotate", from: "0 18 18", to: "360 18 18", dur: "".concat(1 / speed, "s"), repeatCount: "indefinite" })))));
}
